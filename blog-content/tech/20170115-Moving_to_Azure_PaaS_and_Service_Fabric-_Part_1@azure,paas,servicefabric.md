...
- [Part 2](moving-to-azure-paas-and-service-fabric-part-2) (Database, Configuration, Logging, Caching, Service Bus, Emails, Tooling, Rollout)
...
That's quite enough for now. More to come in [Part 2](moving-to-azure-paas-and-service-fabric-part-2).
